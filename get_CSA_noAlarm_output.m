function [ma_s, ma_se, pdat] = get_CSA_noAlarm_output(sd, Rcrit, seq_data, a, a0)
fps=30;
...
[strf, fdat]=CSAHab_fast_noAlarm(Tfinal,Np,kmax, sd, Rcrit, a, seq_data, a0);%Number frames, number ants, max oc kick distribut
% smooth it
kerL=100;
